...
{
    /// <summary>
    /// This class was taken from the source code of the Asp dotnetcore type `FileExtensionContentTypeProvider`
    /// See https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.staticfiles.fileextensioncontenttypeprovider?view=aspnetcore-3.1
    /// </summary>
    public class BogFileExtensionContentTypeProvider
    {
        public BogFileExtensionContentTypeProvider()
        ...
        public BogFileExtensionContentTypeProvider(IDictionary<string, string> mapping)
        {
            if (mapping == null)
            {
