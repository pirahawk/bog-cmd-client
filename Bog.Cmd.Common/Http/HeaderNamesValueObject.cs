namespace Bog.Cmd.Common.Http
{
    /// <summary>
    /// Had to import this from the asp dotnetcore source code from
    /// https://source.dot.net/#Microsoft.Net.Http.Headers/HeaderNames.cs,d86e908b9fe31fb3
    ///
    /// Not sure why but this is not a thing in standard dotnetcore. Cool huh!
    /// </summary>
    public static class HeaderNamesValueObject
    {
